...
// We include the session parameter and pdo bridge
    ...
    if($_POST){
        ...
        //from database we are looking for, whether user nick exist and save the answer in $result
        ...
        //also verify if the second password sended is NULL or string format, then is registered in database 
        if(isset($pass2)){
            if(!$result){
